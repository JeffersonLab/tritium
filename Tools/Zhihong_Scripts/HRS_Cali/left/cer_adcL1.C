...
{ 
  ...
  TString filename;
  //  filename = Form("/w/halla-2/e08014/yez/HRS_Cali/Left/replay/Rootfiles/e08014_L_%d.root",run_number);
  filename = Form("/w/halla-2/e08014/yez/replay/Rootfiles/e08014_L_%d.root",run_number);
   T->Add(filename);
  
// filename = Form("/w/halla-2/e08014/Rootfiles_0721/e08014_L_%d_1.root",run_number);
  // T->Add(filename);
  // filename = Form("/w/halla-2/e08014/Rootfiles_0721/e08014_L_%d_2.root",run_number);
  // T->Add(filename);
  // filename = Form("/w/halla-2/e08014/Rootfiles_0721/e08014_L_%d_3.root",run_number);
  // T->Add(filename);
  ...
  for(i=0;i<10;i++){
    ...
    c1->cd(i+1);
    //  tcut = Form("L.cer.t[%d]>1000.&&(L.prl1.asum_c+L.prl2.asum_c<1500.)",i,i);
    tcut = Form("L.cer.t[%d]>1000.",i,i);
    ...
    */
    ...
    TH1F *h1 = new TH1F("h1",Form("L-HRS Cer_0%d",i+1),250,200,3000);
    h1->SetLineColor(1);
    T->Draw(Form("L.cer.a[%d]>>h1",i), tcut);  
