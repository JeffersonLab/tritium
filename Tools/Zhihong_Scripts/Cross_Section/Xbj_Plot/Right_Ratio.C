...
int main()
{
	...
	int N_21 = 0;
	Merge(Form("./input_right/R21_%s_%s.rt",Target0.Data(),Target.Data()), xbj_21, R_EX_21, R_EX_Err_21, R_MC_21, &N_21);
	...
	int N_23 = 0;
	if(!(Target=="H2"))
		Merge(Form("./input_right/R23_%s_%s.rt",Target0.Data(),Target.Data()), xbj_23, R_EX_23, R_EX_Err_23, R_MC_23, &N_23);
	...
	int N_QE = 0;
	if(!(Target=="H2"))
		Merge(Form("./input_right/RQE_%s_%s.rt",Target0.Data(),Target.Data()), xbj_QE, R_EX_QE, R_EX_Err_QE, R_MC_QE, &N_QE);
	...
	int N_25 = 0;
	Merge(Form("./input_right/R25_%s_%s.rt",Target0.Data(),Target.Data()), xbj_25, R_EX_25, R_EX_Err_25, R_MC_25, &N_25);
	...
	if(Target0=="C12" && Target=="He3"){
		Merge(Form("./input_right/R28_%s_%s.rt",Target0.Data(),Target.Data()), xbj_28, R_EX_28, R_EX_Err_28, R_MC_28, &N_28);
	}
...
//	ex21->Fit("pol0","","",1.75, 2.0);
	...
	c4->cd(); l1->Draw();
	if(bMC){
		c3->Print(Form("./right/%s_%s_XS_Ratio_MC_%s_%s_R.png",Target0.Data(),Target.Data(),Com0.Data(),Com.Data()));
		c3->Print(Form("./right/%s_%s_XS_Ratio_MC_%s_%s_R.pdf",Target0.Data(),Target.Data(),Com0.Data(),Com.Data()));
	}
	else{
		c3->Print(Form("./right/%s_%s_XS_Ratio_%s_%s_R.png",Target0.Data(),Target.Data(),Com0.Data(),Com.Data()));
		c3->Print(Form("./right/%s_%s_XS_Ratio_%s_%s_R.pdf",Target0.Data(),Target.Data(),Com0.Data(),Com.Data()));
	}
	if(bMC){
		c4->Print(Form("./right/%s_%s_XS_Ratio_MC_%s_%s_Zoom_R.png",Target0.Data(),Target.Data(),Com0.Data(),Com.Data()));
		c4->Print(Form("./right/%s_%s_XS_Ratio_MC_%s_%s_Zoom_R.pdf",Target0.Data(),Target.Data(),Com0.Data(),Com.Data()));
	}
	else{
		c4->Print(Form("./right/%s_%s_XS_Ratio_%s_%s_Zoom_R.png",Target0.Data(),Target.Data(),Com0.Data(),Com.Data()));
		c4->Print(Form("./right/%s_%s_XS_Ratio_%s_%s_Zoom_R.pdf",Target0.Data(),Target.Data(),Com0.Data(),Com.Data()));
	}
...
/*	if(aInputFileName.Contains("QE")){
	...
	/*Ratio{{{*/  
	ofstream outfile(Form("./right/XS_%s_%s_%s_%s_%s.dat",Kin0.Data(),Target0.Data(),Target.Data(),Com0.Data(),Com.Data()));
...
void E02019(const TString& aInputFileName, const double aTheta,double* aXbj, double* aR_EX, double* aR_EX_Err, int* aN){
	...
	ofstream outfile(Form("./right/E02019_XS_%s_%s.dat",Target0.Data(),Target.Data()));
	outfile << Form("%7s %14s %14s %14s %14s %14s %14s", "Xbj","Ratio","XS1","XS2","Ratio_Err","XS_Err1","XS_Err2" )<<endl;
