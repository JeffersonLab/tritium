...
//	ex21->Fit("pol0","","",1.75, 2.0);
	...
	if(bMC){
		...
		c4->Print(Form("./both/%s_%s_XS_Ratio_MC_%s_%s_Zoom.pdf",Target0.Data(),Target.Data(),Com0.Data(),Com.Data()));
	}
	else{
		c4->Print(Form("./both/%s_%s_XS_Ratio_%s_%s_Zoom.png",Target0.Data(),Target.Data(),Com0.Data(),Com.Data()));
		c4->Print(Form("./both/%s_%s_XS_Ratio_%s_%s_Zoom.pdf",Target0.Data(),Target.Data(),Com0.Data(),Com.Data()));
	}
...
void E02019(const TString& aInputFileName, const double aTheta,double* aXbj, double* aR_EX, double* aR_EX_Err, int* aN){
	...
	ofstream outfile(Form("./both/E02019_XS_%s_%s.dat",Target0.Data(),Target.Data()));
	outfile << Form("%7s %14s %14s %14s %14s %14s %14s", "Xbj","Ratio","XS1","XS2","Ratio_Err","XS_Err1","XS_Err2" )<<endl;
