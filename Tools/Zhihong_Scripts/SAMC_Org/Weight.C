...
//  cerr <<"Which Kinematics? (3.1,3.2,4.1,etc) "; cin >> Kin;
  ...
  if(filename.Contains("3.1")) 
	  Kin = "3.1";
  else if(filename.Contains("3.2")) 
	  Kin = "3.2";
  else if(filename.Contains("4.1")) 
	  Kin = "4.1";
  else if(filename.Contains("4.2")) 
	  Kin = "4.2";
  else if(filename.Contains("5.0")&&!(filename.Contains("5.05"))) 
	  Kin = "5.0";
  else if(filename.Contains("5.1")) 
	  Kin = "5.1";
  else if(filename.Contains("5.2")) 
	  Kin = "5.2";
  else if(filename.Contains("5.05")) 
	  Kin = "5.05";
  else if(filename.Contains("6.5")) 
	  Kin = "6.5";
  else{
	  cerr <<"Which Kinematics? (3.1,3.2,4.1,etc) "; cin >> Kin;
  }
...
/***********************************************************/
 ...
 TString fKin = "Kin"+Kin;
  ...
  for(int j=0;j<Evt;j++){
	  t1->GetEntry(j);
	  cs = xs->gGet_XS(E_s,E_p,abs(Theta));
	  weight = cs/cs_Center;
