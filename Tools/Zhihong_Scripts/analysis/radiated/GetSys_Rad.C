void GetSys_Rad(){
	ifstream infile11("stat/He3/XS_He3_T21_0_51.table");
	ifstream infile12("stat/He3/XS_He3_T23_0_54.table");
	ifstream infile13("stat/He3/XS_He3_T25_0_83.table");
	ifstream infile14("stat/He3/XS_He3_T28_0_34.table");

	ifstream infile21("stat_q2/He3/XS_He3_T21_0_51.table");
	ifstream infile22("stat_q2/He3/XS_He3_T23_0_54.table");
	ifstream infile23("stat_q2/He3/XS_He3_T25_0_83.table");
	ifstream infile24("stat_q2/He3/XS_He3_T28_0_34.table");

	ifstream infile31("stat_xbj/He3/XS_He3_T21_0_51.table");
	ifstream infile32("stat_xbj/He3/XS_He3_T23_0_54.table");
	ifstream infile33("stat_xbj/He3/XS_He3_T25_0_83.table");
	ifstream infile34("stat_xbj/He3/XS_He3_T28_0_34.table");

	TFile *file = new TFile("He3_XS.root","recreate");
	...
	infile14 >> Com >> Com >> Com >> Com >> Com >> Com >> Com >> Com >> Com >> Com;
	infile24 >> Com >> Com >> Com >> Com >> Com >> Com >> Com >> Com >> Com >> Com;
	infile34 >> Com >> Com >> Com >> Com >> Com >> Com >> Com >> Com >> Com >> Com;
	while(!(infile14.eof())){
		infile14 >> A >> Z >> Angle >> Ep >> j>> Theta >> i >> XS_Born1 >> XS_Rad1 >> tail;
		RadC1 = XS_Rad1 / XS_Born1;
		infile24 >> A >> Z >> Angle >> Ep >> j>> Theta >> i >> XS_Born2 >> XS_Rad2 >> tail;
		RadC2 = XS_Rad2 / XS_Born2;
		infile34 >> A >> Z >> Angle >> Ep >> j>> Theta >> i >> XS_Born3 >> XS_Rad3 >> tail;
		RadC3 = XS_Rad3 / XS_Born3;
	...
	infile14.close(); infile24.close();	infile34.close();
