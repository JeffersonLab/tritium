{
  ...
  TH2F *hh = new TH2F("hh","",810,3500,4310,200,80.0,110.0);
  hh->GetXaxis()->SetTitle("HRS-L Cerenkov Detection Efficiencies");
  ...
  l1->AddEntry(gr1,"Trigger T3","p");
  l1->AddEntry(gr2,"Trigger T7","p");
  l1->Draw();

  TCanvas *cf = new TCanvas("cf","cf",1200,800);
  TH2F *hf = new TH2F("hf","",810,3500,4310,200,80.0,110.0);
  hf->GetXaxis()->SetTitle("HRS-L Calorimeter Detection Efficiencies");
  ...
  l2->AddEntry(gr3,"Trigger T3","p");
  l2->AddEntry(gr4,"Trigger T7","p");
  l2->Draw();
