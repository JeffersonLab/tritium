...
//	TString sKin = Kin; sKin.ReplaceAll("Kin","kin");
//	SAMC_File = Form("cryo_L_%s.root",sKin.Data());
	...
	T->Add(filename);
	if(Target.Contains("He") && (Kin.Contains("3.2")||Kin.Contains("4.2")||Kin.Contains("5.2")||Kin.Contains("6.5"))){
		filename=Form("/work/halla/e08014/disk1/Rootfiles/e08014_%d.root",run_number+1);
		T->Add(filename);
		filename=Form("/work/halla/e08014/disk1/Rootfiles/e08014_%d.root",run_number+2);
		T->Add(filename);
		if(Kin.Contains("5.2")||Kin.Contains("6.5")){
			filename=Form("/work/halla/e08014/disk1/Rootfiles/e08014_%d.root",run_number+3);
			T->Add(filename);
			filename=Form("/work/halla/e08014/disk1/Rootfiles/e08014_%d.root",run_number+4);
			T->Add(filename);
			filename=Form("/work/halla/e08014/disk1/Rootfiles/e08014_%d.root",run_number+5);
			T->Add(filename);
		}
	}
	...
	c1->Print(pic);
	pic=Target+"_"+SAMC_File+Form("%d_fp_cut.pdf",run_number);
	c1->Print(pic);
	pic=Target+"_"+SAMC_File+Form("%d_tg_cut.png",run_number);
	c2->Print(pic);
	pic=Target+"_"+SAMC_File+Form("%d_tg_cut.pdf",run_number);
	c2->Print(pic);
