...
//void plot()
{
  ...
  TString hrs="L";TString target="ca40";  TString kin="kin3.1_real1"; int run_number = 4095;
  ...
  TString Acc_real = "abs(ExTgtL.th)<0.04&&abs(ExTgtL.ph)<0.025&&abs(ExTgtL.y)<0.15&&abs(ExTgtL.dp)<0.035&&abs(RctPtL.z)<0.05";
  TString Acc_simu = "abs(th)<0.04&&abs(L.gold.ph)<0.03&&abs(L.gold.y)<0.003";
