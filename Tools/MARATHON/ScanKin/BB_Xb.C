...
#include "../DIS_Lite.h"
int main(){
    //int Theta[7]={57,59,61,63,65,67,69};
    //double H2_Rate[7]  = { 14.23,  10.85,   8.26,  6.29,  4.79,  3.61,  2.73};
    //double H3_Rate[7]  = {  8.42,   6.39,   4.85,  3.68,  2.79,  2.10,  1.57};
    //double He3_Rate[7] = { 14.59,  11.16,   8.53,  6.52,  4.98,  3.77,  2.85};
    int Theta[7]={69};
    double H2_Rate[1]  = { 2.73};
    double H3_Rate[1]  = { 1.57};
    double He3_Rate{1] = { 2.85};
