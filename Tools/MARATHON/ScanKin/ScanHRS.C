...
void GetRate(const string spec,  const string Com, double E0, double P0, double T0, 
    ...
    TString filename = Form("./results/%s_rate_marathon_E%d_P%d_T%d.root", spec.c_str(), (int)(E0+0.5), (int)(P0+0.5), (int)(T0+0.5));
    if(IsDebug)
        filename = Form("./results/%s_rate_marathon_E%d_P%d_T%d_debug.root", spec.c_str(), (int)(E0+0.5), (int)(P0+0.5), (int)(T0+0.5));
    if(spec=="BB" &&Com=="narrow")	
        filename = Form("./results/%s_rate_marathon_E%d_P%d_T%d_narrow.root",spec.c_str(), (int)(E0+0.5), (int)(P0+0.5), (int)(T0+0.5));
...
int main(){
	...
	const int N_T = 12;
	const int Theta_Bin[N_T] = {29,31,33,35,37,39,41,43,45,47,49,51};
