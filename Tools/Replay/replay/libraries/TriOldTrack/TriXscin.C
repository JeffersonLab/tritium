...
TriXscin::TriXscin( const char* name,
...
//_____________________________________________________________________________
THaAnalysisObject::EStatus TriXscin::Init( const TDatime& date )
{
...
//_____________________________________________________________________________
Int_t TriXscin::ReadDatabase( const TDatime& date )
{
...
//_____________________________________________________________________________
Int_t TriXscin::DefineVariables( EMode mode )
{
  ...
  RVarDef vars[] = {
    ...
    { "trdy",   "track deviation in y-position (m)", "fTrackProj.TriTrackProj.fdX" }, //Does not have a 'fdY' variable...but not a big deal
...
//_____________________________________________________________________________
Int_t TriXscin::Decode( const THaEvData& evdata )
{
...
//_____________________________________________________________________________
Int_t TriXscin::ApplyCorrections( void )
{
...
//_____________________________________________________________________________
Double_t TriXscin::TimeWalkCorrection(const Int_t& paddle,
					     const ESide side)
{
...
//_____________________________________________________________________________
Int_t TriXscin::CoarseProcess( TClonesArray& /* tracks */ )
{
...
//_____________________________________________________________________________
Int_t TriXscin::FineProcess( TClonesArray& tracks )
{
  ...
  for ( int i=0; i<n_track; i++ ) {
    ...
    if ( ! CalcTrackIntercept(theTrack, pathl, xc, yc) ) { // failed to hit
      new ( (*fTrackProj)[i] )
	TriTrackProj(xc,yc,pathl,dy,pad);
      continue;
    }
