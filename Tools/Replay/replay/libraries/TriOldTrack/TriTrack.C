...
const Double_t TriTrack::kBig = 1e38;
...
//_____________________________________________________________________________
void TriTrack::Clear( const Option_t* opt )
{
...
//_____________________________________________________________________________
Int_t TriTrack::AddCluster( THaCluster* c )
{
...
//_____________________________________________________________________________
void TriTrack::Print( Option_t* opt ) const
{
...
//_____________________________________________________________________________
Int_t TriTrack::Compare(const TObject * obj) const
{
  // compare two tracks by chi2/ndof
  // for track array sorting

  const TriTrack* tr = dynamic_cast<const TriTrack*>(obj);
  if (!tr) return 0;
