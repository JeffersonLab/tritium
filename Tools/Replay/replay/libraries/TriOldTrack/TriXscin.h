#ifndef ROOT_TriXscin
#define ROOT_TriXscin
...
class TriXscin : public TriNonTrackingDetector {

public:
  TriXscin( const char* name, 
...
protected:
  ...
  ClassDef(TriXscin,1)   // Generic scintillator class
};
