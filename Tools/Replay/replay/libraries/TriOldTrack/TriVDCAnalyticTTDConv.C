...
ClassImp(TriVDCAnalyticTTDConv)


//______________________________________________________________________________
TriVDCAnalyticTTDConv::TriVDCAnalyticTTDConv()
{
  //Normal constructor
}

//______________________________________________________________________________
TriVDCAnalyticTTDConv::TriVDCAnalyticTTDConv( Double_t vel) 
{
  // Normal constructor 
  fDriftVel = vel;
...
//______________________________________________________________________________
Double_t TriVDCAnalyticTTDConv::ConvertTimeToDist(Double_t time,
						  Double_t tanTheta,
						  Double_t *ddist)
{
