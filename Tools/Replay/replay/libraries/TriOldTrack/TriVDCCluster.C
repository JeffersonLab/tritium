...
const Double_t TriVDCCluster::kBig = 1e38;  // Arbitrary large value

//_____________________________________________________________________________
TriVDCCluster::TriVDCCluster( const TriVDCCluster& rhs ) :
  TObject(rhs),
...
//_____________________________________________________________________________
TriVDCCluster& TriVDCCluster::operator=( const TriVDCCluster& rhs )
{
  // Assignment operator
...
//_____________________________________________________________________________
TriVDCCluster::~TriVDCCluster()
{
  // Destructor
}

//_____________________________________________________________________________
void TriVDCCluster::AddHit(TriVDCHit * hit)
{
...
//_____________________________________________________________________________
void TriVDCCluster::Clear( const Option_t* )
{
...
//_____________________________________________________________________________
Int_t TriVDCCluster::Compare( const TObject* obj ) const
{
  ...
  const TriVDCCluster* rhs = static_cast<const TriVDCCluster*>( obj );
...
//_____________________________________________________________________________
void TriVDCCluster::EstTrackParameters()
{
...
//_____________________________________________________________________________
void TriVDCCluster::ConvertTimeToDist()
{
...
//_____________________________________________________________________________
void TriVDCCluster::FitTrack( EMode /* mode */ )
{
...
//_____________________________________________________________________________
void TriVDCCluster::FitSimpleTrack()
{
...
//_____________________________________________________________________________
void TriVDCCluster::FitSimpleTrackWgt()
{
  // Perform linear fit on drift times. Calculates slope, intercept, and errors.
...
//_____________________________________________________________________________
Int_t TriVDCCluster::GetPivotWireNum() const
{
...
//_____________________________________________________________________________
void TriVDCCluster::CalcChisquare(Double_t& chi2, Int_t& nhits ) const
{
...
//_____________________________________________________________________________
void TriVDCCluster::Print( Option_t* ) const
{
