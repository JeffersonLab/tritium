...
ClassImp(TriVDCUVTrack)

//_____________________________________________________________________________
void TriVDCUVTrack::CalcDetCoords()
{
  ...
  // See, for example, TriVDC::ConstructTracks()
  // 
  // This routine requires several parameters from the TriVDCUVPlane that
...
//_____________________________________________________________________________
void TriVDCUVTrack::CalcChisquare(Double_t& chi2, Int_t& nhits) const
{
  ...
  //   (as done in TriVDC::ConstructTracks)
  //
