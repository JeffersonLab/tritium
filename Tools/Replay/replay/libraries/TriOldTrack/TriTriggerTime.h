#ifndef ROOT_TriTriggerTime  
#define ROOT_TriTriggerTime  
...
class TriTriggerTime : public TriNonTrackingDetector {
 public:
  TriTriggerTime( const char* name="trg", const char* description = "",
		  THaApparatus* a = NULL );
 ...
 protected:
  ...
  ClassDef(TriTriggerTime,0)
};

#endif  /*  ROOT_TriTriggerTime  */
