...
TriTriggerTime::TriTriggerTime( const char* name, const char* desc,
				THaApparatus* apparatus ) :
  TriNonTrackingDetector(name, desc, apparatus),
...
//____________________________________________________________________________
Int_t TriTriggerTime::ReadDatabase( const TDatime& date )
{
...
//____________________________________________________________________________
void TriTriggerTime::Clear(Option_t* )
{
...
//____________________________________________________________________________
Int_t TriTriggerTime::Decode(const THaEvData& evdata)
{
...
//____________________________________________________________________________
Int_t TriTriggerTime::DefineVariables( EMode mode )
{
