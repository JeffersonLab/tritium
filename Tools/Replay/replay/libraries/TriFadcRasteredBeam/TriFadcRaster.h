#ifndef ROOT_TriFadcRaster
#define ROOT_TriFadcRaster
...
class TriFadcRaster : public THaBeamDet {

public:
  TriFadcRaster( const char* name, const char* description = "",
		   THaApparatus* a = NULL );
  virtual ~TriFadcRaster();
...
protected:
  ...
  //  TriFadcRaster() {}
  //  TriFadcRaster( const TriFadcRaster& ) {}
  //  TriFadcRaster& operator=( const TriFadcRaster& ) { return *this; }
  ...
  ClassDef(TriFadcRaster,0)   // Generic Raster class
};
