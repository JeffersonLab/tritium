...
void prl1_adc()
{
  ...
  cin >> run_number;
  TString filename;
  filename = Form("../Rootfiles/e08014_%d.root",run_number);
  TChain *T = new TChain("T");
  T->Add(filename);
  T->Add(Form("../Rootfiles/e07006_HRS_%d.root",run_number));

//   T->Add("../Rootfiles/e07006_HRS_2851.root");
//   T->Add("../Rootfiles/e07006_HRS_2852.root");
//   T->Add("../Rootfiles/e07006_HRS_2853.root");
//   T->Add("../Rootfiles/e07006_HRS_2853_1.root");
//   T->Add("../Rootfiles/e07006_HRS_2855.root");
//   T->Add("../Rootfiles/e07006_HRS_2856.root");
//   T->Add("../Rootfiles/e07006_HRS_2857.root");
...
//   T->Add("../Rootfiles/e07006_HRS_2860.root");
//   T->Add("../Rootfiles/e07006_HRS_2860_1.root");
//   T->Add("../Rootfiles/e07006_HRS_2860_2.root");
  ...
  for(i=0;i<16;i++){
    c1->cd(i+1);
    TH1F *tt1 = new TH1F("tt1",Form("PRL1_%d",i+1),200,250,800);
    T->Draw(Form("L.prl1.a[%d]>>tt1",i),Form("L.prl1.a[%d]>100.0",i));
    ...
    T->Draw(Form("L.prl1.a[%d]>>h1",i),Form("L.prl1.a[%d]>100.0&&L.cer.asum_p<400.&&L.prl2.a<600.",i));
    h1->Fit("gaus","Q","",min,max);
    ped_val = gaus->GetParameter(1);
    max = ped_val + 2.5*gaus->GetParameter(2);   
    if(i==0||i==1||i==2)
      h1->Fit("landau","+Q","",max+10,max+100);
    else if(i==3)
      h1->Fit("landau","+Q","",max+10,max+100);
    else
      h1->Fit("landau","+Q","",max+10,max+100);
  ...
  for(i=0;i<16;i++){
    c2->cd(i+1);
    TH1F *tt2 = new TH1F("tt2",Form("PRL1_%d",i+17),200,250,800);
    T->Draw(Form("L.prl1.a[%d]>>tt2",i+16),Form("L.prl1.a[%d]>100.0&&L.cer.asum_p<400.&&L.prl2.a<600.",i+16));
    ...
    T->Draw(Form("L.prl1.a[%d]>>h2",i+16),Form("L.prl1.a[%d]>100.0",i+16));
    h2->Fit("gaus","Q","",min,max);
    ped_val = gaus->GetParameter(1);
    max = ped_val + 2.5*gaus->GetParameter(2);   
    if(i==0||i==1||i==2)
      h2->Fit("landau","+Q","",max+10,max+100);
    else if(i==3)
      h2->Fit("landau","+Q","",max+10,max+100);
    else
      h2->Fit("landau","+Q","",max+10,max+100);
  ...
  c2->Print(Form("L_prl1_adj2_%d.ps",run_number));
  ...
  for(i=0;i<2;i++){
    c3->cd(i+1);
    TH1F *tt3 = new TH1F("tt3",Form("PRL1_%d",i+33),200,250,800);
    T->Draw(Form("L.prl1.a[%d]>>tt3",i+32),Form("L.prl1.a[%d]>100.0",i+32));
    ...
    TH1F *h3 = new TH1F("h3",Form("PRL1_%d",i+33),100,min-40,min+400);
    T->Draw(Form("L.prl1.a[%d]>>h3",i+32),Form("L.prl1.a[%d]>100.0&&L.cer.asum_p<600.",i+32));
    h3->Fit("gaus","Q","",min,max);
    ped_val = gaus->GetParameter(1);
    max = ped_val + 2.5*gaus->GetParameter(2);   
    if(i==0||i==1||i==2)
      h3->Fit("landau","+Q","",max+10,max+100);
    else if(i==3)
      h3->Fit("landau","+Q","",max+10,max+100);
    else
      h3->Fit("landau","+Q","",max+10,max+100);
