...
gStyle->SetTitleFillColor(-1); 
	...
	Double_t nu,Q2,xbj,angle,Ep,Livetime,Ntg,Ni,Nf_EX,Nf_AL,Nf_SAMC,Nf_SAMC_Gen,BinCor,XS_MC;
	...
	Double_t pXS1[200],pXS_Err1[200],pEp1[200],pEp_Err1[200],pXS_MC1[200],pYield_MC1[200],pYield_EX1[200],pYield_MC_Err1[200],pYield_EX_Err1[200],pYield_AL1[200],pYield_AL_Err1[200];
	Double_t pXS2[200],pXS_Err2[200],pEp2[200],pEp_Err2[200],pXS_MC2[200],pYield_MC2[200],pYield_EX2[200],pYield_MC_Err2[200],pYield_EX_Err2[200],pYield_AL2[200],pYield_AL_Err2[200];
	Double_t pXS3[200],pXS_Err3[200],pEp3[200],pEp_Err3[200],pXS_MC3[200],pYield_MC3[200],pYield_EX3[200],pYield_MC_Err3[200],pYield_EX_Err3[200],pYield_AL3[200],pYield_AL_Err3[200];
	Double_t pXS4[200],pXS_Err4[200],pEp4[200],pEp_Err4[200],pXS_MC4[200],pYield_MC4[200],pYield_EX4[200],pYield_MC_Err4[200],pYield_EX_Err4[200],pYield_AL4[200],pYield_AL_Err4[200];
   
   	//Yield Ratio of Exp. to MC. Data
	Double_t pY_R1[200],pY_R2[200],pY_R_Err1[200],pY_R_Err2[200];
	Double_t pY_R3[200],pY_R4[200],pY_R_Err3[200],pY_R_Err4[200];

	//Yield Ratio of Cryo-Target to Dummy
	Double_t pYR_AL1[200],pYR_AL2[200],pYR_AL_Err1[200],pYR_AL_Err2[200];
	Double_t pYR_AL3[200],pYR_AL4[200],pYR_AL_Err3[200],pYR_AL_Err4[200];
	/*}}}*/
	...
	{
		cerr<<Form("XS=%e, Ep=%e, Y_EX=%e, Y_MC=%e", XS, Ep, Yield_EX, Yield_MC)<<endl;
		if ( XS>0.0 && sqrt(pow(XS_Sys_Err,2)+pow(XS_Stat_Err,2))/XS <0.5)
		{
			pXS1[Count1] = XS;      pXS_Err1[Count1] = XS_Stat_Err;
			pEp1[Count1] = Ep;    pEp_Err1[Count1] = 0.0;
			...
			pYR_AL1[Count1]=Yield_AL/Yield_EX*100.0;//%
			pYR_AL_Err1[Count1]=pYR_AL1[Count1] * sqrt( pow(Y_EX_Stat_Err/Yield_EX,2) + pow(Y_AL_Stat_Err/Yield_AL,2) );
	...
	if(bMore){
		...
		while ( run_2>>XS>>XS_Stat_Err>>XS_Sys_Err>>XS_MC>>xbj>>angle>>Ep>>nu>>Q2>>BinCor>>Livetime>>Ntg>>Ni>>Nf_EX>>Nf_AL>>Nf_SAMC>>Nf_SAMC_Gen>>Yield_EX>>Y_EX_Stat_Err>>Y_EX_Sys_Err>>Yield_MC>>Y_MC_Stat_Err>>Y_MC_Sys_Err>>Yield_AL>>Y_AL_Stat_Err>>Y_AL_Sys_Err )
		{
			...
			if (XS>0.0 && sqrt(pow(XS_Sys_Err,2)+pow(XS_Stat_Err,2))/XS <0.5)
			{
				...
				pEp2[Count2] = Ep;    pEp_Err2[Count2] = 0.0;
				...
				pYR_AL2[Count2]=Yield_AL/Yield_EX*100.0;//%
				pYR_AL_Err2[Count2]=pYR_AL2[Count2] * sqrt( pow(Y_EX_Stat_Err/Yield_EX,2) + pow(Y_AL_Stat_Err/Yield_AL,2) );
...
//			bMore1 = kFALSE;
	 ...
	 Kin_Name3 = Form("Kin%s",Kin.Data());
		...
		while ( run_3>>XS>>XS_Stat_Err>>XS_Sys_Err>>XS_MC>>xbj>>angle>>Ep>>nu>>Q2>>BinCor>>Livetime>>Ntg>>Ni>>Nf_EX>>Nf_AL>>Nf_SAMC>>Nf_SAMC_Gen>>Yield_EX>>Y_EX_Stat_Err>>Y_EX_Sys_Err>>Yield_MC>>Y_MC_Stat_Err>>Y_MC_Sys_Err>>Yield_AL>>Y_AL_Stat_Err>>Y_AL_Sys_Err )
		{
			...
			if ( XS>0.0 && sqrt(pow(XS_Sys_Err,2)+pow(XS_Stat_Err,2))/XS <0.5)
			{
				...
				pEp3[Count3] = Ep;    pEp_Err3[Count3] = 0.0;
				...
				pYR_AL3[Count3]=Yield_AL/Yield_EX*100.0;//%
				pYR_AL_Err3[Count3]=pYR_AL3[Count3] * sqrt( pow(Y_EX_Stat_Err/Yield_EX,2) + pow(Y_AL_Stat_Err/Yield_AL,2) );
	...
	if(bMore2){
		...
		while ( run_4>>XS>>XS_Stat_Err>>XS_Sys_Err>>XS_MC>>xbj>>angle>>Ep>>nu>>Q2>>BinCor>>Livetime>>Ntg>>Ni>>Nf_EX>>Nf_AL>>Nf_SAMC>>Nf_SAMC_Gen>>Yield_EX>>Y_EX_Stat_Err>>Y_EX_Sys_Err>>Yield_MC>>Y_MC_Stat_Err>>Y_MC_Sys_Err>>Yield_AL>>Y_AL_Stat_Err>>Y_AL_Sys_Err )
		{
			...
			if ( XS>0.0 && sqrt(pow(XS_Sys_Err,2)+pow(XS_Stat_Err,2))/XS <0.5)
			{
				...
				pEp4[Count4] = Ep;    pEp_Err4[Count4] = 0.0;
				...
				pYR_AL4[Count4]=Yield_AL/Yield_EX*100.0;//%
				pYR_AL_Err4[Count4]=pYR_AL4[Count4] * sqrt( pow(Y_EX_Stat_Err/Yield_EX,2) + pow(Y_AL_Stat_Err/Yield_AL,2) );
    ...
    Double_t Ep_Min = Min_X;
    Double_t Ep_Max = Max_X;

	TCanvas *c1 = new TCanvas("c1","c1",1200,800);
	TH2F* xs = new TH2F("xs","",1000,Ep_Min,Ep_Max,1000,Min/2.,Max*2.0);
	xs->SetStats(kFALSE);
	xs->SetXTitle("E_{p}");
	...
	TGraphErrors *pl_x1 = new TGraphErrors(Count1,pEp1,pXS1,pEp_Err1,pXS_Err1);
	pl_x1-> SetMarkerColor(2);
	pl_x1-> SetMarkerSize(1.0);
	pl_x1-> SetMarkerStyle(24);
	pl_x1-> GetXaxis()->SetTitle("E_{p}");
	pl_x1-> GetYaxis()->SetTitle("#sigma");

	TGraphErrors *pl_x11 = new TGraphErrors(Count1,pEp1,pXS_MC1,pEp_Err1,pEp_Err1);
	pl_x11-> SetMarkerColor(46);
	pl_x11-> SetMarkerSize(0.8);
	pl_x11-> SetLineColor(46);
	pl_x11-> SetLineWidth(2.0);
	pl_x11-> SetMarkerStyle(20);
	pl_x11-> GetXaxis()->SetTitle("E_{p}");
	pl_x11-> GetYaxis()->SetTitle("#sigma_{mc}");

	TGraphErrors *pl_x3 = new TGraphErrors(Count3,pEp3,pXS3,pEp_Err3,pXS_Err3);
	TGraphErrors *pl_x13 = new TGraphErrors(Count3,pEp3,pXS_MC3,pEp_Err3,pEp_Err3);
	if(bMore1){
		// pl_x1-> SetTitle(Form("C12,P_{0}=2.905 GeV/c, #theta=21^{o}"));
		pl_x3-> SetMarkerColor(4);
		pl_x3-> SetMarkerSize(1.0);
		pl_x3-> SetMarkerStyle(28);
		pl_x3-> GetXaxis()->SetTitle("E_{p}");
	...
	//Reduce the Min_Yield to include the Aluminlium Yields
	if(Target=="H2"||Target=="He3"||Target=="He4"){
		Min_Yield/=1e2;	
	}
	TCanvas *c2 = new TCanvas("c2","c2",1200,800);
	TH2F* y = new TH2F("y","",1000,Ep_Min,Ep_Max,1000,Min_Yield/2.,Max_Yield*2.0);
	y->SetStats(kFALSE);
	y->SetXTitle("E_{p}");
	...
	TGraphErrors *pl_y1 = new TGraphErrors(Count1,pEp1,pYield_EX1,pEp_Err1,pYield_EX_Err1);
	pl_y1-> SetMarkerColor(2);
	pl_y1-> SetMarkerSize(1.0);
	pl_y1-> SetMarkerStyle(24);
	pl_y1-> GetXaxis()->SetTitle("E_{p}");
	pl_y1-> GetYaxis()->SetTitle("Yield");

	TGraphErrors *pl_y21 = new TGraphErrors(Count1,pEp1,pYield_AL1,pEp_Err1,pYield_AL_Err1);
	pl_y21-> SetMarkerColor(45);
	pl_y21-> SetMarkerSize(1.0);
	pl_y21-> SetMarkerStyle(27);
	pl_y21-> GetXaxis()->SetTitle("E_{p}");
	pl_y21-> GetYaxis()->SetTitle("Yield");

	TGraphErrors *pl_y11 = new TGraphErrors(Count1,pEp1,pYield_MC1,pEp_Err1,pYield_MC_Err1);
	pl_y11-> SetMarkerColor(46);
	pl_y11-> SetMarkerSize(0.6);
	pl_y11-> SetLineColor(46);
	pl_y11-> SetLineWidth(2.0);
	pl_y11-> SetMarkerStyle(20);
	pl_y11-> GetXaxis()->SetTitle("E_{p}");
	pl_y11-> GetYaxis()->SetTitle("Yield");

	TGraphErrors *pl_y3 = new TGraphErrors(Count3,pEp3,pYield_EX3,pEp_Err3,pYield_EX_Err3);
	TGraphErrors *pl_y13 = new TGraphErrors(Count3,pEp3,pYield_MC3,pEp_Err3,pYield_MC_Err3);
	TGraphErrors *pl_y23 = new TGraphErrors(Count3,pEp3,pYield_AL3,pEp_Err3,pYield_AL_Err3);
	if(bMore1){
		pl_y3-> SetMarkerColor(4);
		pl_y3-> SetMarkerSize(1.0);
		pl_y3-> SetMarkerStyle(28);
		pl_y3-> GetXaxis()->SetTitle("E_{p}");
		pl_y3-> GetYaxis()->SetTitle("Yield");

		pl_y23-> SetMarkerColor(30);
		pl_y23-> SetMarkerSize(1.1);
		pl_y23-> SetMarkerStyle(3);
		pl_y23-> GetXaxis()->SetTitle("E_{p}");
	...
	TH2F* r = new TH2F("r","",1000,Ep_Min,Ep_Max,1000,0.0, 2.0);
	r->SetStats(kFALSE);
	r->SetXTitle("E_{p}");
	...
	TGraphErrors *pl_r1 = new TGraphErrors(Count1,pEp1,pY_R1,pEp_Err1,pY_R_Err1);
	pl_r1-> SetMarkerColor(2);
	pl_r1-> SetMarkerSize(1.0);
	pl_r1-> SetMarkerStyle(24);
	pl_r1-> GetXaxis()->SetTitle("E_{p}");
	pl_r1-> GetYaxis()->SetTitle("Yield_{EX}/Yield_{MC}");

	TGraphErrors *pl_r3 = new TGraphErrors(Count3,pEp3,pY_R3,pEp_Err3,pY_R_Err3);
	if(bMore1){
		pl_r3-> SetMarkerColor(4);
		pl_r3-> SetMarkerSize(1.0);
		pl_r3-> SetMarkerStyle(28);
		pl_r3-> GetXaxis()->SetTitle("E_{p}");
	...
	TH2F* r_al = new TH2F("r_al","",1000,Ep_Min,Ep_Max,1000,0.0, 10.0);
	r_al->SetStats(kFALSE);
	r_al->SetXTitle("E_{p}");
	r_al->GetXaxis()->CenterTitle(1);
	r_al->GetXaxis()->SetTitleFont(32);
	r_al->GetXaxis()->SetTitleSize(0.06);
	r_al->SetYTitle("Yield_{AL}/Yield_{EX} (%)");
	r_al->GetYaxis()->CenterTitle(1);
	r_al->GetYaxis()->SetTitleFont(32);
	r_al->GetYaxis()->SetTitleSize(0.04);
	r_al->Draw(); 

	TGraphErrors *al_r1 = new TGraphErrors(Count1,pEp1,pYR_AL1,pEp_Err1,pYR_AL_Err1);
	al_r1-> SetMarkerColor(2);
	al_r1-> SetMarkerSize(1.0);
	al_r1-> SetMarkerStyle(24);
	al_r1-> GetXaxis()->SetTitle("E_{p}");
	al_r1-> GetYaxis()->SetTitle("Yield_{AL}/Yield_{EX}");

	TGraphErrors *al_r3 = new TGraphErrors(Count3,pEp3,pYR_AL3,pEp_Err3,pYR_AL_Err3);
	if(bMore1){
		al_r3-> SetMarkerColor(4);
		al_r3-> SetMarkerSize(1.0);
		al_r3-> SetMarkerStyle(28);
		al_r3-> GetXaxis()->SetTitle("E_{p}");
		al_r3-> GetYaxis()->SetTitle("Yield_{AL}/Yield_{EX}");
	}
	/*}}}*/

	/*Third{{{*/
	TGraphErrors *pl_x2 = new TGraphErrors(Count2,pEp2,pXS2,pEp_Err2,pXS_Err2);
	TGraphErrors *pl_x12 = new TGraphErrors(Count2,pEp2,pXS_MC2,pEp_Err2,pEp_Err2);
	TGraphErrors *pl_y2 = new TGraphErrors(Count2,pEp2,pYield_EX2,pEp_Err2,pYield_EX_Err2);
	TGraphErrors *pl_y12 = new TGraphErrors(Count2,pEp2,pYield_MC2,pEp_Err2,pYield_MC_Err2);
	TGraphErrors *pl_y22 = new TGraphErrors(Count2,pEp2,pYield_AL2,pEp_Err2,pYield_AL_Err2);
	TGraphErrors *pl_r2 = new TGraphErrors(Count2,pEp2,pY_R2,pEp_Err2,pY_R_Err2);

	TGraphErrors *al_r2 = new TGraphErrors(Count2,pEp2,pYR_AL2,pEp_Err2,pYR_AL_Err2);

	if(bMore){
		pl_x2-> SetMarkerColor(6);
		pl_x2-> SetMarkerSize(1.0);
		pl_x2-> SetMarkerStyle(25);
		pl_x2-> GetXaxis()->SetTitle("E_{p}");
		...
		pl_x12-> GetXaxis()->SetTitle("E_{p}");
		pl_x12-> GetYaxis()->SetTitle("#sigma_{mc}");

		pl_y2-> SetMarkerColor(6);
		pl_y2-> SetMarkerSize(1.0);
		pl_y2-> SetMarkerStyle(25);
		pl_y2-> GetXaxis()->SetTitle("E_{p}");
		pl_y2-> GetYaxis()->SetTitle("Yield");

		pl_y22-> SetMarkerColor(38);
		pl_y22-> SetMarkerSize(1.0);
		pl_y22-> SetMarkerStyle(26);
		pl_y22-> GetXaxis()->SetTitle("E_{p}");
		...
		pl_y12-> GetXaxis()->SetTitle("E_{p}");
		pl_y12-> GetYaxis()->SetTitle("Yield");

		pl_r2-> SetMarkerColor(6);
		pl_r2-> SetMarkerSize(1.0);
		pl_r2-> SetMarkerStyle(25);
		pl_r2-> GetXaxis()->SetTitle("E_{p}");
		pl_r2-> GetYaxis()->SetTitle("Yield_{EX}/Yield_{MC}");
	
		al_r2-> SetMarkerColor(6);
		al_r2-> SetMarkerSize(1.0);
		al_r2-> SetMarkerStyle(25);
		al_r2-> GetXaxis()->SetTitle("E_{p}");
		al_r2-> GetYaxis()->SetTitle("Yield_{AL}/Yield_{EX}");
}
	/*}}}*/

	/*Forth{{{*/
	TGraphErrors *pl_x4 = new TGraphErrors(Count4,pEp4,pXS4,pEp_Err4,pXS_Err4);
	TGraphErrors *pl_x14 = new TGraphErrors(Count4,pEp4,pXS_MC4,pEp_Err4,pEp_Err4);
	TGraphErrors *pl_y4 = new TGraphErrors(Count4,pEp4,pYield_EX4,pEp_Err4,pYield_EX_Err4);
	TGraphErrors *pl_y14 = new TGraphErrors(Count4,pEp4,pYield_MC4,pEp_Err4,pYield_MC_Err4);
	TGraphErrors *pl_y24 = new TGraphErrors(Count4,pEp4,pYield_AL4,pEp_Err4,pYield_AL_Err4);
	TGraphErrors *pl_r4 = new TGraphErrors(Count4,pEp4,pY_R4,pEp_Err4,pY_R_Err4);
	
	TGraphErrors *al_r4 = new TGraphErrors(Count4,pEp4,pYR_AL4,pEp_Err4,pYR_AL_Err4);

	if(bMore2){
		//pl_x4-> SetTitle(form("c12,p_{0}=3.055 gev/c, #theta=21^{o}"));
		pl_x4-> SetMarkerColor(8);
		pl_x4-> SetMarkerSize(1.1);
		pl_x4-> SetMarkerStyle(30);
		pl_x4-> GetXaxis()->SetTitle("E_{p}");
		...
		pl_x14-> GetXaxis()->SetTitle("E_{p}");
		pl_x14-> GetYaxis()->SetTitle("#sigma_{mc}");

		pl_y4-> SetMarkerColor(8);
		pl_y4-> SetMarkerSize(1.1);
		pl_y4-> SetMarkerStyle(30);
		pl_y4-> GetXaxis()->SetTitle("E_{p}");
		pl_y4-> GetYaxis()->SetTitle("Yield");

		pl_y24-> SetMarkerColor(28);
		pl_y24-> SetMarkerSize(1.1);
		pl_y24-> SetMarkerStyle(2);
		pl_y24-> GetXaxis()->SetTitle("E_{p}");
		...
		pl_y14-> GetXaxis()->SetTitle("E_{p}");
		pl_y14-> GetYaxis()->SetTitle("Yield");

		pl_r4-> SetMarkerColor(8);
		pl_r4-> SetMarkerSize(1.1);
		pl_r4-> SetMarkerStyle(30);
		pl_r4-> GetXaxis()->SetTitle("E_{p}");
		pl_r4-> GetYaxis()->SetTitle("Yield_{EX}/Yield_{MC}");

		al_r4-> SetMarkerColor(8);
		al_r4-> SetMarkerSize(1.1);
		al_r4-> SetMarkerStyle(30);
		al_r4-> GetXaxis()->SetTitle("E_{p}");
		al_r4-> GetYaxis()->SetTitle("Yield_{EX}/Yield_{MC}");
	}
	/*}}}*/
	...
	l1->Draw();
	c1->Print(Form("%s_XS_Kin%s_%s.pdf",Target.Data(),Kin.Data(),Comment.Data()));
	c1->Print(Form("%s_XS_Kin%s_%s.png",Target.Data(),Kin.Data(),Comment.Data()));
	/*}}}*/
	...
	l2->Draw();
	c2->Print(Form("%s_Yield_Kin%s_%s.pdf",Target.Data(),Kin.Data(),Comment.Data()));
	c2->Print(Form("%s_Yield_Kin%s_%s.png",Target.Data(),Kin.Data(),Comment.Data()));
	/*}}}*/
	...
	mg3->Draw("P");
	l3->Draw();
	c3->Print(Form("%s_YR_Kin%s_%s.pdf",Target.Data(),Kin.Data(),Comment.Data()));
	c3->Print(Form("%s_YR_Kin%s_%s.png",Target.Data(),Kin.Data(),Comment.Data()));
	/*}}}*/
	...
	TLegend *l4 = new TLegend(0.65,0.59,0.90, 0.94,Form("%s Target",Target.Data()));
	l4->SetBorderSize(0);
	l4->SetTextSize(0.025);
	l4->SetTextFont(22);

	l4->AddEntry(al_r1, Form("Y_{AL}/Y_{EX}:  %s (HRS-%s)",Kin_Name1.Data(), Arm1.Data()),"p");
	mg4->Add(al_r1);

	if(bMore){
		l4->AddEntry(al_r2, Form("Y_{AL}/Y_{EX}:  %s (HRS-%s)",Kin_Name2.Data(), Arm2.Data()),"p");
		mg4->Add(al_r2);
	}

	if(bMore1){	
		l4->AddEntry(al_r3, Form("Y_{AL}/Y_{EX}:  %s (HRS-%s)",Kin_Name3.Data(), Arm3.Data()),"p");
		mg4->Add(al_r3);
	}
	if(bMore2){
		l4->AddEntry(al_r4, Form("Y_{AL}/Y_{EX}:  %s (HRS-%s)",Kin_Name4.Data(), Arm4.Data()),"p");
		mg4->Add(al_r4);
	}
	mg4->Draw("P");
	l4->Draw();
//	c4->Print(Form("%s_AL_YR_Kin%s_%s.pdf",Target.Data(),Kin.Data(),Comment.Data()));
//	c4->Print(Form("%s_AL_YR_Kin%s_%s.png",Target.Data(),Kin.Data(),Comment.Data()));
	/*}}}*/

	/*Yield  Ratio Zoom In{{{*/
	TCanvas *c33 = new TCanvas("c33","c33",1200,800);
	TH2F* rr = new TH2F("rr","",1000,Ep_Min,Ep_Max,1000,0.6, 1.3);//Zoom in plot
	rr->SetStats(kFALSE);
	rr->SetXTitle("E_{p}");
	rr->GetXaxis()->CenterTitle(1);
	rr->GetXaxis()->SetTitleFont(32);
	rr->GetXaxis()->SetTitleSize(0.06);
	rr->SetYTitle("Yield_{EX}/Yield_{MC}");
	rr->GetYaxis()->CenterTitle(1);
	...
	l33->SetBorderSize(0);
	l33->SetTextSize(0.025);
	l33->SetTextFont(22);

	l33->AddEntry(pl_r1, Form("Y_{EX}/Y_{MC}:  %s (HRS-%s)",Kin_Name1.Data(), Arm1.Data()),"p");
	mg33->Add(pl_r1);

	if(bMore){
		l33->AddEntry(pl_r2, Form("Y_{EX}/Y_{MC}:  %s (HRS-%s)",Kin_Name2.Data(), Arm2.Data()),"p");
		mg33->Add(pl_r2);
	}

	if(bMore1){	
		l33->AddEntry(pl_r3, Form("Y_{EX}/Y_{MC}:  %s (HRS-%s)",Kin_Name3.Data(), Arm3.Data()),"p");
		mg33->Add(pl_r3);
	}
	if(bMore2){
		l33->AddEntry(pl_r4, Form("Y_{EX}/Y_{MC}:  %s (HRS-%s)",Kin_Name4.Data(), Arm4.Data()),"p");
		mg33->Add(pl_r4);
	}
	mg33->Draw("P");
	l33->Draw();
	c33->Print(Form("%s_YR_Kin%s_%s_Zoom.pdf",Target.Data(),Kin.Data(),Comment.Data()));
	c33->Print(Form("%s_YR_Kin%s_%s_Zoom.png",Target.Data(),Kin.Data(),Comment.Data()));
	/*}}}*/
