...
int main()
{
	...
	TString Input_Name1 = "./left/XS_5.0_Ca48_Ca40_S17_S17.dat",  Title_Name1 = "abs(#deltaP)=3\%, abs(#theta_{tg})=30mrad";
	TString Input_Name2 = "./left/XS_5.0_Ca48_Ca40_Th40_Th40.dat",  Title_Name2 = "abs(#deltaP)=3\%, abs(#theta_{tg})=40mrad";
	TString Input_Name3 = "./left/XS_5.0_Ca48_Ca40_Dp_Dp.dat",  Title_Name3 = "abs(#deltaP)=4\%, abs(#theta_{tg})=30mrad";
	TString Input_Name4 = "./left/XS_5.0_Ca48_Ca40_DpTh40_DpTh40.dat",  Title_Name4 = "abs(#deltaP)=4\%, abs(#theta_{tg})=40mrad";
	TString Output_Name = "Acc_Ca48_Ca40_QE";

	TLegend *l1 = new TLegend(0.17,0.64,0.50, 0.94,"R(Ca48/Ca40) at 25^{#circ} on HRS-L");
...
//	RMAX = 2.0;
	...
	c3->cd();
	TH2F *h3 = new TH2F("h3","",300,XMIN-0.2,XMAX+0.2,300,RMIN-0.5,RMAX+0.5);
	h3->SetStats(kFALSE);
	h3->SetXTitle("x");
	...
	cerr<<"--- Ploting 4th set of data"<<endl;
		...
		ex4->SetMarkerSize(2.0);
		ex4->SetMarkerColor(1);
		ex4->SetLineColor(1);
		c3->cd(); ex4->Draw("P");
