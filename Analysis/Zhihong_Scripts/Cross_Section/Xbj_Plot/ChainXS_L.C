...
int main()
{
	...
	ofstream outfile(Form("XS_%s_%s_L.dat",Target.Data(),Com.Data()));
...
/*}}}*/
	...
	l1->Draw();
	c1->Print(Form("%s_XS_All_xbj_%s_L.pdf",Target.Data(),Com.Data()));
	c1->Print(Form("%s_XS_All_xbj_%s_L.png",Target.Data(),Com.Data()));
	/*}}}*/
    ...
    l2->Draw();
    c2->Print(Form("%s_XS_All_%s_L.png",Target.Data(),Com.Data()));
	c2->Print(Form("%s_XS_All_%s_L.pdf",Target.Data(),Com.Data()));
 	/*}}}*/
	/*}}}*/
