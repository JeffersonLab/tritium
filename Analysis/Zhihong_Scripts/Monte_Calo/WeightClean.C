...
/***********************************************************/
  ...
  TH1F *hxtg = new TH1F("hxtg","",200,-0.01,0.01);
 ...
 TH1F *hytg;TH1F *hrpz; 
    ...
    hytg = new TH1F("hytg","",200,-0.07,0.07);
    hrpz = new TH1F("hrpz","",200,-0.12,0.12);
  }
  else{
    hytg = new TH1F("hytg","",200,-0.01,0.01);
    hrpz = new TH1F("hrpz","",200,-0.01,0.01);
  }
  ...
  TH2F *hxphtg = new TH2F("hxphtg","",200,0.5,8.0,200,-0.06,0.06);
