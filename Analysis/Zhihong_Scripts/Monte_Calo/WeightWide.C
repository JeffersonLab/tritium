...
//int main()
void WeightWide(TString filename)
{
...
/***********************************************************/
 ...
 if(filename.Contains("he3")||filename.Contains("h2")||filename.Contains("he4")){
  ...
  TH1F *hphtg = new TH1F("hphtg","Weighted Phi_tg",200,-0.045,0.045);
  ...
  TH2F *hdpphtg = new TH2F("hdpphtg","Weighted Phi_tg vs Dp_tg",200,-0.07,0.07,200,-0.06,0.06);
...
/*}}}*/
  ...
  if(filename.Contains("h2") || filename.Contains("H2"))
	  Target = "H2";
  else if(filename.Contains("he3") || filename.Contains("He3"))
	  Target = "He3";
  else if(filename.Contains("he4") || filename.Contains("He4"))
	  Target = "He4";
  else if(filename.Contains("c12") || filename.Contains("C12"))
	  Target = "C12";
  else if(filename.Contains("ca40") || filename.Contains("Ca40"))
	  Target = "Ca40";
  else if(filename.Contains("ca48") || filename.Contains("Ca48"))
	  Target = "Ca48";
  else{ 
	  cerr <<"Which Target? (H2,He3,He4,C12,Ca40,Ca48 or Dummy) "; cin >> Target;
  }
  if(filename.Contains("kin3.1"))
	  Kin = "3.1";
  else if(filename.Contains("kin3.2"))
	  Kin = "3.2";
  else if(filename.Contains("kin4.1"))
	  Kin = "4.1";
  else if(filename.Contains("kin4.2"))
	  Kin = "4.2";
  else if(filename.Contains("kin5.0") && !(filename.Contains("kin5.05")))
	  Kin = "5.0";
  else if(filename.Contains("kin5.05"))
	  Kin = "5.05";
  else if(filename.Contains("kin5.1"))
	  Kin = "5.1";
  else if(filename.Contains("kin5.2"))
	  Kin = "5.2";
  else if(filename.Contains("kin6.5"))
	  Kin = "6.5";
  else{ 
  ...
  if(abs(cs_Center)<10e-10)
	  cs_Center = 0.001;
  cerr<<Form("--> XS Center = %e",cs_Center)<<endl;
  double cs = 0.0;
  double weight=1.0;
  ...
  hrpz->Write(); hdpphtg->Write();
  hxphtg->Write();

  /*}}}*/
  f1->Close();
  delete xs;
  cerr<<" --- Finished Weighting SAMC File = "<< filename.Data()<<endl;
}
