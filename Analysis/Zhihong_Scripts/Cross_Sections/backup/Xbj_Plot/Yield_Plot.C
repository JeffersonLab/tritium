...
gStyle->SetTitleFillColor(-1); 
   ...
   if(Target=="H2")
	...
	TH2F* r = new TH2F("r","",1000,Min_X,Max_X,1000,0.0, 2.0);
	r->SetStats(kFALSE);
	r->SetXTitle("x_{bj}");
...
//	c3->Print(Form("%s_YR_Kin%s_xbj.png",Target.Data(),Kin.Data()));
	...
	mg33->Draw("P");
	l33->Draw();
	c33->Print(Form("%s_YR_Kin%s_%s_xbj_Zoom.pdf",Target.Data(),Kin.Data(),Comment.Data()));
	c33->Print(Form("%s_YR_Kin%s_%s_xbj_Zoom.png",Target.Data(),Kin.Data(),Comment.Data()));
	/*}}}*/
