...
gStyle->SetTitleFillColor(-1); 
	...
	Double_t pXS1[200], pXS_Err1[200], pEp1[200],  pEp_Err1[200],pXS_MC1[200],pYield_MC1[200],pYield_EX1[200],pYield_MC_Err1[200],pYield_EX_Err1[200];
	Double_t pXS2[200], pXS_Err2[200], pEp2[200],  pEp_Err2[200],pXS_MC2[200],pYield_MC2[200],pYield_EX2[200],pYield_MC_Err2[200],pYield_EX_Err2[200];
	Double_t pXS3[200], pXS_Err3[200], pEp3[200],  pEp_Err3[200],pXS_MC3[200],pYield_MC3[200],pYield_EX3[200],pYield_MC_Err3[200],pYield_EX_Err3[200];
	Double_t pXS4[200], pXS_Err4[200], pEp4[200],  pEp_Err4[200],pXS_MC4[200],pYield_MC4[200],pYield_EX4[200],pYield_MC_Err4[200],pYield_EX_Err4[200];
...
//			bMore1 = kFALSE;
	...
	TH2F* r = new TH2F("r","",1000,Ep_Min,Ep_Max,1000,0.0, 3.0);
	r->SetStats(kFALSE);
	r->SetXTitle("E_{p}");
