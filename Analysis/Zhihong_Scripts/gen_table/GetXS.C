...
/*
    ...
    Double_t cs_rad_table = xs1->gGet_XS(Ep,Ep,Theta);	
    Double_t cs_born_table = xs1->gGet_XS_Born(Ep,Ep,Theta);	

	cerr << Form("From Table, XS_Born = %e, XS_Rad = %e", cs_born_table,cs_rad_table)<<endl;
*/
	return 0;
}
